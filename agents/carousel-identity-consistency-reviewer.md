...
drive the recurring illustrated faces, facial expressions, clothes, posture, and
relationship energy for Anchal/Aachu and Himanshu/Zuv.

---

## Required Input

- Selected identity bundle: 2-4 story-relevant images from `identity_images/`
...
- selected identity image paths present in the prompt pack.

---

## Hard Fails

- Identity paths exist only in metadata but not in the actual prompt.
