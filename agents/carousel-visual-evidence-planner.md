...
- source photos, identity references, and style references;
...
6. Name the prop or setting that must not become the premise.
7. Provide one backup scene if the primary scene risks repetition.
8. Mark GO / REPAIR / STOP for that slide.
