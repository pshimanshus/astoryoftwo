...
- corpus/raw/2026-05-17-DYJpjt9CQYY-comments-apify.json
- corpus/media/DYJpjt9CQYY/contact-sheet.jpg
...
He did not choose the socially approved quiet version.
...
- The hook is universal: the viewer understands the relationship pattern before
  knowing Aachu and Zuv.
...
- The Apify comments sample shows strong tag behavior: 13 of 15 scraped
  comments include an @mention.

## Copy Pressure

This theme is highly copyable because creators can swap in their own quirks:
overpacking, crying while saying "I'm fine," needing snacks, mood swings,
dramatic exits, outfit chaos, or silence that means "come closer."

The reusable container is:
...
Do not overuse the literal "He didn't marry..." phrasing. Preserve the
emotional machine, not only the opening sentence.
