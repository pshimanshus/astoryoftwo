...
def prepare_codex_builtin_image_generation(
    ...
    *,
    ...
    result = write_generation_state(
        ...
        reason="Prompt files are ready for the Codex image tool; final PNGs still need in-session generation and packaging.",
        slides=records,
        extra={
            ...
            "identity_reference_requirement": (
                ...
                "Codex image tool generation; the final art must preserve Aachu/Zuv face structure."
            ),
        },
    )
