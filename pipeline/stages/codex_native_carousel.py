    ...
    prompt_slides = [
        {
            ...
            "prompt": (
                ...
                "Style references: use every attached observational-intimacy-premium reference image as style only. "
                ...
                "watercolor-and-ink visual language, warm ivory paper texture, linework, spacing, wardrobe continuity, "
                "composition, and recurring props. Shared or non-A Story reference images are only mood/composition, "
                "story, text, gesture, and object references; they must not control visual style. "
                "Do not use style references as face identity references. "
