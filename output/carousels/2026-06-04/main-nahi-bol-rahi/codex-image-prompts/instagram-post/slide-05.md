...
- Attach/view the image references below, then paste only `output/carousels/2026-06-04/main-nahi-bol-rahi/codex-image-prompts/instagram-post/slide-05.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-06-04/main-nahi-bol-rahi/final/slide-05.png`
...
Identity references:
- config/references/identity/aachu/face-01.png
- config/references/identity/aachu/portrait-01.jpg
- config/references/identity/zuv/face-01.png
- config/references/identity/zuv/portrait-01.jpg
...
Create slide 5 as the proof-first frame: Zuv quietly keeps her glass too. Render exact text inside the artwork.

## Expected Output

- Save packaged final to `output/carousels/2026-06-04/main-nahi-bol-rahi/final/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-06-04/main-nahi-bol-rahi/final/model-native-source/instagram-post-slide-05.png`.
