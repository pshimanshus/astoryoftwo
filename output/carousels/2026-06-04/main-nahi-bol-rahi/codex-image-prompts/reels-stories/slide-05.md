...
- Attach/view the image references below, then paste only `output/carousels/2026-06-04/main-nahi-bol-rahi/codex-image-prompts/reels-stories/slide-05.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-06-04/main-nahi-bol-rahi/final-reels-stories/slide-05.png`
...
- Save packaged final to `output/carousels/2026-06-04/main-nahi-bol-rahi/final-reels-stories/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-06-04/main-nahi-bol-rahi/final/model-native-source/reels-stories-slide-05.png`.
