...
- Prompt file path: `output/carousels/2026-07-20/same-name-two-temperatures/codex-image-prompts/instagram-post/slide-05.prompt.txt`.
...
- Required final file: `output/carousels/2026-07-20/same-name-two-temperatures/final/slide-05.png`
...
- Save packaged final to `output/carousels/2026-07-20/same-name-two-temperatures/final/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-07-20/same-name-two-temperatures/final/model-native-source/instagram-post-slide-05.png`.
