...
- Instagram post prompts: `output/carousels/2026-08-14/certain-of-you-lost-in-us-no-script-repair-01/codex-image-prompts/instagram-post`
- Paste-ready generator prompts: `.prompt.txt` files beside each `.md` handoff file.

Final images still required:

- `final/slide-01.png` through `slide-06.png` (Instagram post)
...
- slide 04: `Some days, love did not tell us
what to do.`
- paste only this proof prompt after attaching references: `codex-image-prompts/instagram-post/slide-04.prompt.txt`
