...
- Prompt file path: `output/carousels/2026-07-12/after-one-hour-with-you-zuv-pov/codex-image-prompts/instagram-post/slide-05.prompt.txt`.
...
- Required final file: `output/carousels/2026-07-12/after-one-hour-with-you-zuv-pov/final/slide-05.png`
...
- Save packaged final to `output/carousels/2026-07-12/after-one-hour-with-you-zuv-pov/final/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-07-12/after-one-hour-with-you-zuv-pov/final/model-native-source/instagram-post-slide-05.png`.
