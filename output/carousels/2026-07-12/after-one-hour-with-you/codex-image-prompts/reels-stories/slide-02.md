...
- Prompt file path: `output/carousels/2026-07-12/after-one-hour-with-you/codex-image-prompts/reels-stories/slide-02.prompt.txt`.
...
- Required final file: `output/carousels/2026-07-12/after-one-hour-with-you/final-reels-stories/slide-02.png`
...
before them, everything feels too loud.

## Expected Output

- Save packaged final to `output/carousels/2026-07-12/after-one-hour-with-you/final-reels-stories/slide-02.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-07-12/after-one-hour-with-you/final/model-native-source/reels-stories-slide-02.png`.
