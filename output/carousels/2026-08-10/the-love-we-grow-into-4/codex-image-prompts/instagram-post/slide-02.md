...
- Prompt file path: `output/carousels/2026-08-10/the-love-we-grow-into-4/codex-image-prompts/instagram-post/slide-02.prompt.txt`.
...
- Required final file: `output/carousels/2026-08-10/the-love-we-grow-into-4/final/slide-02.png`
...
We will still get irritated
over keys, routes,
and very small things.

## Expected Output

- Save packaged final to `output/carousels/2026-08-10/the-love-we-grow-into-4/final/slide-02.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-08-10/the-love-we-grow-into-4/final/model-native-source/instagram-post-slide-02.png`.
