...
Then she went back
and checked it with him. - Nonlinear callback to before the date, viewed entirely from OUTSIDE the apartment in a dry corridor after the front door is fully closed. Use a medium-wide, nearly straight-on view of the closed door so the whole action reads without copy. Stage Aachu and Zuv as two separate, non-overlapping figures on opposite sides of the latch zone, with at least one forearm of clear empty space between their torsos: no hug, no waist hold, no leaning against each other, and no couple touch. Zuv stands on the handle side and pulls the single exterior handle with his right hand; his left hand stays naturally hidden behind his own body, and no key is visible in this frame. Aachu has visibly returned from the elevator doors shown deeper in the corridor behind her; both feet and her turned torso point back from the elevator toward the apartment door. Standing separately from Zuv, she extends her right arm across clear open air and presses her fully visible right palm flat on the closed door panel about one hand-width beside the latch. Her fingers, palm, wrist, forearm, and sleeve must remain continuously readable from shoulder to door. Her soft tote hangs from her left shoulder and the tightly rolled bone-dry umbrella rests under her left arm, keeping that hand hidden without covering the focal right arm. Both look toward the door action with small knowing smiles. The two separated bodies, two distinct action arms, closed door, exterior corridor, and visible elevator-return path must make the silent read unmistakable: he tests the handle; she came back and tests the same closed door with him. Their clothes, hair, shoes, umbrella, and corridor floor are completely fresh and dry. Exactly two people. Never show an interior entryway, open door, post-date return, rain marks, Aachu touching Zuv, overlapping torsos, viewer-facing glamour pose, key dangling from the lock, or only one partner checking.
