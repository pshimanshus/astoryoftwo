...
- Paste the full prompt from `slide-02.prompt.txt` into the image generator.
- Prompt file path: `/Users/himanshusharma/astoryoftwo-analysis/output/carousels/2026-07-28/the-person-missing-from-my-memories/codex-image-prompts/instagram-post/slide-02.prompt.txt`.
- After generation, package the returned image with `scripts/package_generated_carousel.py` or the proof-specific workflow.

## Prompt Source

Paste the full prompt from `slide-02.prompt.txt`. This markdown file intentionally does not duplicate the prompt body, so `.prompt.txt` remains the only generation prompt source.
...
- Required final file: `/Users/himanshusharma/astoryoftwo-analysis/output/carousels/2026-07-28/the-person-missing-from-my-memories/final/slide-02.png`
...
- Dossier: output/carousels/2026-07-28/the-person-missing-from-my-memories/identity-dossier.json
- Preflight: output/carousels/2026-07-28/the-person-missing-from-my-memories/identity-generation-preflight.md

## Actual Image Inputs

- output/carousels/2026-07-28/the-person-missing-from-my-memories/identity-face-contact-sheet.jpg
- config/references/identity/aachu/face-06.png
...
- Save packaged final to `/Users/himanshusharma/astoryoftwo-analysis/output/carousels/2026-07-28/the-person-missing-from-my-memories/final/slide-02.png`.
- Source provenance should point to the Codex generated image copied into `/Users/himanshusharma/astoryoftwo-analysis/output/carousels/2026-07-28/the-person-missing-from-my-memories/final/model-native-source/instagram-post-slide-02.png`.
