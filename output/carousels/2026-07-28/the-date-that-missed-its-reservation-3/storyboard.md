...
- 2: The date began with one missing key
...
- 5: It wasn’t really the wrong turn.
...
Then she went back
and checked it with him. - Nonlinear callback to before departure for the date, viewed entirely from OUTSIDE the apartment in a dry corridor after the front door is fully closed. Use a medium-wide, nearly straight-on view of the closed door so the whole action reads without copy. Stage Aachu and Zuv as two separate, non-overlapping figures on opposite sides of the latch zone, with at least one forearm of clear empty space between their torsos: no hug, no waist hold, no leaning against each other, and no couple touch. Zuv stands on the handle side with his hips and both shoes still aimed outward toward the elevator, twisting only his upper torso back to pull the single exterior handle with his right hand; his left hand stays naturally hidden behind his own body, and no key is visible in this frame. Deeper in the corridor behind Aachu, the elevator doors are visibly halfway through closing and its call button still glows. Aachu is caught in a clear mid-pivot back from that elevator: her left foot remains planted and pointed toward the elevator, her right foot steps back toward the apartment door, her heel is lifted, and three tiny fading graphite motion ticks curve from the elevator threshold to her trailing heel. These are physical movement marks, not an arrow, label, ghost figure, or duplicate body. Standing separately from Zuv, she extends her right arm across clear open air and presses her fully visible right palm flat on the closed door panel about one hand-width beside the latch. Her fingers, palm, wrist, forearm, and sleeve must remain continuously readable from shoulder to door. Her soft tote hangs from her left shoulder and the tightly rolled bone-dry umbrella rests under her left arm, keeping that hand hidden without covering the focal right arm. Both look toward the door action with small knowing smiles. Both participate in the check: their outward-pointing lower bodies, reach-back actions, Aachu's elevator-to-door pivot marks, two separated torsos, two distinct action arms, closed door, and dry corridor must make the silent read unmistakable—while leaving for the date, he tests the handle; she turns back from the elevator and tests the same closed door with him. Their clothes, hair, shoes, unused umbrella, and corridor floor are completely fresh and dry. Exactly two people. Never show an interior entryway, open door, post-date return, rain marks, Aachu touching Zuv, overlapping torsos, viewer-facing glamour pose, readable arrows or labels, ghosted body duplicates, key dangling from the lock, or only one partner checking.
