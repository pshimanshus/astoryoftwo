...
- Prompt file path: `output/carousels/2026-07-30/the-date-that-missed-its-reservation-17/codex-image-prompts/instagram-post/slide-05.prompt.txt`.
...
- Required final file: `output/carousels/2026-07-30/the-date-that-missed-its-reservation-17/final/slide-05.png`
...
It wasn’t really the wrong turn.
...
- Save packaged final to `output/carousels/2026-07-30/the-date-that-missed-its-reservation-17/final/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-07-30/the-date-that-missed-its-reservation-17/final/model-native-source/instagram-post-slide-05.png`.
