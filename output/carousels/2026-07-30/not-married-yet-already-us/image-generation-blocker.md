...
- Instagram post prompts: `output/carousels/2026-07-30/not-married-yet-already-us/codex-image-prompts/instagram-post`
- Paste-ready generator prompts: `.prompt.txt` files beside each `.md` handoff file.

Final images still required:

- `final/slide-01.png` through `slide-11.png` (Instagram post)
...
- slide 06: `Fight bhi proper hoti hai.`
- paste only this proof prompt after attaching references: `codex-image-prompts/instagram-post/slide-06.prompt.txt`
