...
copy: Pouch-searching. Bathroom-searching.
...
ON-IMAGE TEXT:
Pouch-searching. Bathroom-searching.

SCENE:
A single airy domestic composition, not a collage: an open denim or soft pink pouch sits in the foreground while a bathroom shelf and mirror sit softly behind it. Aachu checks both spaces with rising playful suspicion, visible through a natural reflection or side profile. Zuv is absent. Keep the exact text as one line if possible; if it must wrap, preserve the wording and punctuation exactly.
