...
status: READY_FOR_REFERENCE_IMAGE_GENERATION
surface: reels-stories
copy: Then he opened his stock drawer.
...
SCENE:
Zuv appears for the first time with an active story job. He is seated, kneeling comfortably, or leaning naturally close to a neat household stock drawer while opening it with one hand. The drawer has small organized sections for skincare, chargers, clips, and tiny household backups, but no visible written section labels. Aachu is only a partial surprised side profile, shoulder, or soft edge-of-frame presence if she helps the scene. Frame Zuv through his upper body, hand, and drawer-opening action so the action proves the line.

SURFACE:
Generate this as the Reels/Stories Output: separate native 9:16 vertical composition, 1080x1920 if size is available. Do not crop, extend, pad, or resize from a 4:5 image.
...
hands, body position, and eye-line must not contradict the ON-IMAGE TEXT. If
the text says socks before pants, the man cannot already be wearing pants; the
pants must be visibly separate and unworn. If a slide depends on a habit or
ritual, show the habit or its evidence clearly enough that the scene still
works when the text is hidden. Aachu and Zuv must always look natural,
flattering, and physically believable. No crouched, cramped, squatting,
awkwardly folded, broken, or unflattering poses. Legs and feet must be
