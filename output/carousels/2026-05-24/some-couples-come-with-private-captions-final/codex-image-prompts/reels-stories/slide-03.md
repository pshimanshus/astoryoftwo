...
- Attach/view the image references below, then paste only `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/codex-image-prompts/reels-stories/slide-03.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-03.png`
...
Use case: illustrated private-caption carousel. Asset type: complete publishable slide 3 of 8, generated separately as native 4:5 Instagram post and native 9:16 Reels/Stories. Scene: rainy window corner in a cozy room. Aachu wears a soft sweater and pajama pants, sitting tense with phone in hand and shoulders tight. Zuv wears a rolled-sleeve home shirt, phone down, leaning in and listening before trying to solve anything. Place 'stressed' near Aachu and 'listening first' near Zuv. Make Zuv's action visible: body turned toward her, attentive eyes, quiet hand nearby. Keep labels clean and away from faces/hands. Warm ASOT paper texture and hand-drawn style, tiny @a.storyof.two bottom-right.

## Expected Output

- Save packaged final to `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-03.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/model-native-source/reels-stories-slide-03.png`.
