...
- Attach/view the image references below, then paste only `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/codex-image-prompts/reels-stories/slide-04.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-04.png`
...
Use case: illustrated private-caption carousel. Asset type: complete publishable slide 4 of 8, generated separately as native 4:5 Instagram post and native 9:16 Reels/Stories. Scene: night street-food or tiny dessert stall with warm lights. Aachu wears a printed dress or bright dupatta and lights up over a tiny dessert box or small find. Zuv wears a casual jacket, watching her smile instead of the object, visibly happy because she is happy. Place 'excited' near Aachu and 'happy she's smiling' near Zuv. The labels must be exact, readable, and integrated into the illustration. Keep the scene airy, not crowded. Tiny @a.storyof.two bottom-right. No logo signs, no brand names.

## Expected Output

- Save packaged final to `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-04.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/model-native-source/reels-stories-slide-04.png`.
