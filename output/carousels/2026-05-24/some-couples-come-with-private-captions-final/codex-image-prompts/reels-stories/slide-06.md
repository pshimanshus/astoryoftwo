...
- Attach/view the image references below, then paste only `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/codex-image-prompts/reels-stories/slide-06.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-06.png`
...
Use case: illustrated private-caption carousel. Asset type: complete publishable slide 6 of 8, generated separately as native 4:5 Instagram post and native 9:16 Reels/Stories. Scene: winter market walkway with soft lights. Zuv wears a dark jacket and performs toughness while carrying something sweet or protective, like a scarf or little bag. Aachu wears a long coat and warm scarf, looking at him with a private smile because she knows the softness underneath. Place 'acting tough' near Zuv and 'knows he's soft' near Aachu. This slide must make the private caption mutual. Warm hand-drawn ASOT style, no macho pose, no generic romance poster.

## Expected Output

- Save packaged final to `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final-reels-stories/slide-06.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/model-native-source/reels-stories-slide-06.png`.
