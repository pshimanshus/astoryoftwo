...
- Attach/view the image references below, then paste only `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/codex-image-prompts/instagram-post/slide-05.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/slide-05.png`
...
Use case: illustrated private-caption carousel. Asset type: complete publishable slide 5 of 8, generated separately as native 4:5 Instagram post and native 9:16 Reels/Stories. Scene: small grocery or market aisle. Aachu wears a denim jacket and red shoes, judging one random item with a clear dislike face. Zuv wears a cream sweater, already putting the item back with serious agreement, on her side before the debate starts. Place 'doesn't like it' near Aachu and 'agrees' near Zuv. Make it same-team comedy, not scolding. Warm ASOT style, simple shelves, no readable brand names, tiny @a.storyof.two bottom-right.

## Expected Output

- Save packaged final to `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/slide-05.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/some-couples-come-with-private-captions-final/final/model-native-source/instagram-post-slide-05.png`.
