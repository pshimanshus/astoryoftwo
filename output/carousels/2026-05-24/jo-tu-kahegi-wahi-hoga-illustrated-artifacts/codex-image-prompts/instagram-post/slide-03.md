...
- Attach/view the image references below, then paste only `output/carousels/2026-05-24/jo-tu-kahegi-wahi-hoga-illustrated-artifacts/codex-image-prompts/instagram-post/slide-03.prompt.txt` into the image generator.
...
- Required final file: `output/carousels/2026-05-24/jo-tu-kahegi-wahi-hoga-illustrated-artifacts/final/slide-03.png`
...
- Save packaged final to `output/carousels/2026-05-24/jo-tu-kahegi-wahi-hoga-illustrated-artifacts/final/slide-03.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/jo-tu-kahegi-wahi-hoga-illustrated-artifacts/final/model-native-source/instagram-post-slide-03.png`.
