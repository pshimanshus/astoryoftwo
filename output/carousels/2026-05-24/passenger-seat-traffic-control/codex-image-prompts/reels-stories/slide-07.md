...
- Required final file: `output/carousels/2026-05-24/passenger-seat-traffic-control/final-reels-stories/slide-07.png`
...
Maybe love is one steering wheel and two opinions.
...
A complete publishable illustrated carousel slide. Final earned thesis. Wide warm car interior from behind: one steering wheel visible, both partners in frame, Aachu gesturing softly toward the road and Zuv smiling forward, relaxed and part of the same joke. Safe simple road ahead, no route details. Exact copy: Maybe love is one steering wheel and two opinions. Text in upper warm-paper space, brandmark bottom-right. No generic romance pose.

## Expected Output

- Save packaged final to `output/carousels/2026-05-24/passenger-seat-traffic-control/final-reels-stories/slide-07.png`.
- Source provenance should point to the Codex generated image copied into `output/carousels/2026-05-24/passenger-seat-traffic-control/final/model-native-source/reels-stories-slide-07.png`.
